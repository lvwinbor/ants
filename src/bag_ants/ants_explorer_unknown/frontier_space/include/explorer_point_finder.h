...
#include <msg_utils/FreeSpaceInfo.h>
#include <msg_utils/FreeSpace.h>
#include <msg_utils/FrontierInfo.h>
#include <msg_utils/SuperViewPoint.h>
#include <msg_utils/ViewPoint.h>

#include <frontier_space/FreeSpaceInfoMsg.h>
#include <frontier_space/FrontierClusterListMsg.h>
#include <frontier_space/old_svp.h>
#include <frontier_space/FSLAndFCLMsg.h>
...
public:
    ...
    std::unordered_map<int, ros::Time> last_msg_time;
    pair<int, SuperViewPointList> svp_list_comm;
    ...
    int inx_of_freespace_pub, inx_of_frontier_pub;
    vector<Vector3d> tour_positions;
    vector<Vector3d> tour_positions2;
    ...
    // 多机交互相关
    ros::Publisher mcar_FreeSpaceAndFrontierInfo_pub;
    ros::Publisher mcar_FreeSpaceInfo_pub;
    // ros::Publisher mcar_FrontierInfo_pub;
    ros::Publisher old_svp_pub;
    ros::Subscriber mcar_FreeSpaceAndFrontierInfo_sub;
    ros::Subscriber mcar_FreeSpaceInfo_sub;
    // ros::Subscriber mcar_FrontierInfo_sub;
    ros::Subscriber old_svp_sub;
    ros::Timer comm2others_timer;
    ros::Timer comm2others_once_freespace_timer;
    ros::Subscriber tour_sub;
    // ros::Timer comm2others_once_frontiers_timer;
    // 通信约束测试
    double comm_range;
    ros::Subscriber odom1_sub;
    ros::Subscriber odom2_sub;
    void odomCallback(const nav_msgs::OdometryConstPtr msg);
    void tourCallback(const msg_utils::GridTourConstPtr msg);
    Eigen::Vector3d odom1_pos, odom2_pos;

    void mcar_FreeSpaceAndFrontierInfoCallback(const msg_utils::FreeSpaceAndFrontierInfoConstPtr msg);
    void comm2others_once(const ros::TimerEvent& /*event*/);
    void comm2others_once_freespace(const ros::TimerEvent& /*event*/);
    // void comm2others_once_frontiers(const ros::TimerEvent& /*event*/);
    void old_svp_callback(const frontier_space::old_svpConstPtr msg);
    void mcar_FreeSpaceInfo_callback(const frontier_space::FSLAndFCLMsgConstPtr msg);
    // void mcar_FrontierInfo_callback(const frontier_space::FrontierClusterListMsgConstPtr msg);
