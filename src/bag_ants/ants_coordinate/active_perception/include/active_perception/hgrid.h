 ...
 * @Date: 2023-11-25 14:13:34
 * @LastEditors: Chenyang Zhang && 1727326672@qq.com
 * @LastEditTime: 2024-04-06 13:09:47
 * @FilePath: /bit_zcy_001/src/bag_ants/ants_coordinate/active_perception/include/active_perception/hgrid.h
 * @Description: 
 * 
...
public:
  ...
  void getFrontiersInGrid(const vector<int>& grid_ids, vector<int>& ftr_ids, vector<int>& ftr2_ids);
