...
bool useInclRateToSlow = false; // 是否使用倾斜率来减速
double inclRateThre = 120.0; // 倾斜率阈值
double slowRate1 = 0.25; // 减速率1
double slowRate2 = 0.5; // 减速率2
double slowTime1 = 2.0; // 减速时间1
double slowTime2 = 2.0; // 减速时间2
bool useInclToStop = false; // 是否使用倾斜度来停车
...
double joyToSpeedDelay = 2.0; // 手柄到速度的延迟时间
