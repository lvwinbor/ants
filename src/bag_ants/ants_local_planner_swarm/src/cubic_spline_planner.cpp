...
void CubicSplineClass::update_formation(double formation_length_unit) {
    ...
    */
    ...
    point_in_leader(0) = -4.0 * formation_length_unit + 0.2;
    ...
    */
    ...
    point_in_leader << -2.0 * formation_length_unit + 0.2, 1.8 * formation_length_unit;
    coneTrans(point_in_leader, formation_triangle[2], move);
...
int main(int argc,char **argv)
{
    ...
    path2follower = nh.advertise<nav_msgs::Path>("path",1,true);
